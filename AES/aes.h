...
public:
    ...
    void Cipher(unsigned char* input, unsigned char* output, unsigned char *key, int keySize = Bits128);  // encipher 16-bit input
    void InvCipher(unsigned char * input, unsigned char * output, unsigned char *key, int keySize = Bits128);  // decipher 16-bit input
